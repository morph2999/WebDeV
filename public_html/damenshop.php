        ...
        <div id="mitte">
            ...
            <div id="inhalt">    
                <table align="center">
                    ...
                    $sqlcount = mysql_query("SELECT * FROM produktda");
                    $anzahl = mysql_num_rows($sqlcount) / 2;
                    
                    $sql1 = mysql_query("SELECT * FROM produktda LIMIT $anzahl");
                    $sql2 = mysql_query("SELECT * FROM produktda LIMIT $anzahl OFFSET $anzahl");
