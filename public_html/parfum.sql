...
UPDATE `parfum`.`produkthe` SET `Bild` = "http://i00.twenga.com/beauty-gesundheit/eau-de-toilette-men/hugo-boss-just-different-p_32710101vb.jpg" Where `ID` = 1;
UPDATE `parfum`.`produkthe` SET `Bild` = "http://images.hugoboss.com/is/image/boss/20_hbeu58013651_999_21?$re_detail$" Where `ID` = 2;
UPDATE `parfum`.`produkthe` SET `Bild` = "http://cdn.idealo.com/folder/Product/3304/7/3304791/s1_produktbild_mid/giorgio-armani-code-homme-eau-de-toilette.jpg" Where `ID` = 3;
UPDATE `parfum`.`produkthe` SET `Bild` = "http://cdn.idealo.com/folder/Product/2227/8/2227835/s1_produktbild_mid/dolce-gabbana-d-g-the-one-gentleman-eau-de-toilette-30-ml.jpg" Where `ID` = 4;
UPDATE `parfum`.`produkthe` SET `Bild` = "http://cdn.idealo.com/folder/Product/600/7/600735/s1_produktbild_mid/givenchy-gentleman-eau-de-toilette-100-ml.jpg" Where `ID` = 5;
UPDATE `parfum`.`produkthe` SET `Bild` = "http://cdn.idealo.com/folder/Product/3512/4/3512450/s1_produktbild_mid/james-bond-007-eau-de-toilette.jpg" Where `ID` = 6;
UPDATE `parfum`.`produkthe` SET `Bild` = "http://i.iparfumerie.de/view/5/davidoff/ddfcwmm_aedt10-01/davidoff-cool-water-man-eau-de-toilette-fur-herren___13.jpg" Where `ID` = 7;
UPDATE `parfum`.`produkthe` SET `Bild` = "http://www.parfumerie-discounter.de/bilder/produkte/gross/JOOP-HOMME-Eau-De-Toilette-125-ml.jpg" Where `ID` = 8;
UPDATE `parfum`.`produkthe` SET `Bild` = "https://bilder.baur.de/pool/formata/1574888.jpg" Where `ID` = 9;
UPDATE `parfum`.`produkthe` SET `Bild` = "http://cdn.idealo.com/folder/Product/4738/7/4738748/s1_produktbild_mid/chanel-bleu-de-chanel-eau-de-parfum-150-ml.jpg" Where `ID` = 10;